...
const projects = [
  { number: "01", status: "持续更新", title: "VLA 学习与实战", description: "面向运动控制工程师的 14 章系统教程。不是论文摘要集合，而是从数学直觉、代码实验走到机器人接口的完整路线。", tags: ["VLA", "π₀.₅", "World Models", "中文教程"], href: "/learning/vla" },
