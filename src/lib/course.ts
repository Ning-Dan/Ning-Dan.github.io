...
export const modules: CourseModule[] = [
  ...
  { index: 1, slug: "math-foundations", phase: "桥接", title: "VLA 数学地基", subtitle: "先理解概率、损失、优势与生成过程，再读公式", hours: "5h", level: "手推", tags: ["Probability", "RL", "ODE"], outcome: "能从一条抓杯样本解释核心概念，再读懂 VLA 训练、生成与后训练公式。" },
  ...
  { index: 4, slug: "act-cvae", phase: "核心", title: "ACT 与 CVAE", subtitle: "为什么预测动作块，潜变量与重叠融合各做什么", hours: "5h", level: "手推", tags: ["ACT", "CVAE", "Temporal Ensemble"], outcome: "能解释并实现 ACT 的训练/推理信息流，而不只把 ACT 当成一个 baseline 名称。" },
  ...
  { index: 13, slug: "post-training", phase: "系统", title: "VLA 后训练与数据闭环", subtitle: "第一次训练后，怎样用纠错、数据与奖励继续改进", hours: "7h", level: "综合", tags: ["HIL", "DAgger", "RL"], outcome: "能根据基础策略成功率、奖励可信度和安全条件选择后训练方法，并设计不会污染测试集的数据闭环。" },
